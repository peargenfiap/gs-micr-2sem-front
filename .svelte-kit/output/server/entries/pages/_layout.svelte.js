  ...
  return `${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    header: () => {
      return `${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
        headline: () => {
          return `<strong class="mb-4 flex items-center justify-center text-xl" data-svelte-h="svelte-gfrfsm">Global Solution 2 - Microservice And Web Engineering ODS</strong>`;
        }
      })} `;
    },
    default: () => {
